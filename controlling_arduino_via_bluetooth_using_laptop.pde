...
void draw(){
  ...
  rect(50, 200, 150, 50, 10);  // Turn ON Button
  rect(250, 200, 150, 50, 10); // Turn OFF Button

  fill(0);
  textSize(20);
  int servingsFirst = 0;
  text(servingsFirst, 218, 135);
  int servingsSecond = 0;
  text(servingsSecond, 218, 235); 
  fill(255);
  textSize(32);
  text("+Serving",60, 135);
  text("-Serving", 255, 135);
  text("+Serving",60, 235);
  text("-Serving", 255, 235);
  textSize(24);
  fill(33);
  text("Status:", 180, 300);
  textSize(30);
  textSize(16);
  text("Program made by Wesley Wong", 100, 420);
  text(ledStatus, 180, 350); // Prints the string comming from the Arduino
